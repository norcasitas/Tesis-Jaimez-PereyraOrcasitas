...
public class WSDLSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case WSDLPackage.IPORT_TYPE: {
			...
			Object result = caseIPortType(iPortType);
			if (result == null)
				result = caseIAttributeExtensible(iPortType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IOPERATION: {
			...
			Object result = caseIOperation(iOperation);
			if (result == null)
				result = caseIElementExtensible(iOperation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IINPUT: {
			...
			Object result = caseIInput(iInput);
			if (result == null)
				result = caseIAttributeExtensible(iInput);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IOUTPUT: {
			...
			Object result = caseIOutput(iOutput);
			if (result == null)
				result = caseIAttributeExtensible(iOutput);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IFAULT: {
			...
			Object result = caseIFault(iFault);
			if (result == null)
				result = caseIAttributeExtensible(iFault);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IMESSAGE: {
			...
			Object result = caseIMessage(iMessage);
			if (result == null)
				result = caseIElementExtensible(iMessage);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IPART: {
			...
			Object result = caseIPart(iPart);
			if (result == null)
				result = caseIAttributeExtensible(iPart);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.ISERVICE: {
			...
			Object result = caseIService(iService);
			if (result == null)
				result = caseIElementExtensible(iService);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IPORT: {
			...
			Object result = caseIPort(iPort);
			if (result == null)
				result = caseIElementExtensible(iPort);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IBINDING: {
			...
			Object result = caseIBinding(iBinding);
			if (result == null)
				result = caseIElementExtensible(iBinding);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IBINDING_OPERATION: {
			...
			Object result = caseIBindingOperation(iBindingOperation);
			if (result == null)
				result = caseIElementExtensible(iBindingOperation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IBINDING_INPUT: {
			...
			Object result = caseIBindingInput(iBindingInput);
			if (result == null)
				result = caseIElementExtensible(iBindingInput);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IBINDING_OUTPUT: {
			...
			Object result = caseIBindingOutput(iBindingOutput);
			if (result == null)
				result = caseIElementExtensible(iBindingOutput);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IBINDING_FAULT: {
			...
			Object result = caseIBindingFault(iBindingFault);
			if (result == null)
				result = caseIElementExtensible(iBindingFault);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IEXTENSIBILITY_ELEMENT: {
			...
			Object result = caseIExtensibilityElement(iExtensibilityElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IDEFINITION: {
			...
			Object result = caseIDefinition(iDefinition);
			if (result == null)
				result = caseIElementExtensible(iDefinition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IIMPORT: {
			...
			Object result = caseIImport(iImport);
			if (result == null)
				result = caseIAttributeExtensible(iImport);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case WSDLPackage.IMAP: {
			...
			Object result = caseIMap(iMap);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IURL: {//esto no se como hacer
			//URL iurl = (URL) theEObject;
			//Object result = caseIURL(iurl);
			//if (result == null)
			//	result = defaultCase(theEObject);
			//return result;
		}
		case WSDLPackage.IEXTENSION_REGISTRY: {
			...
			Object result = caseIExtensionRegistry(iExtensionRegistry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case WSDLPackage.IITERATOR: {
			...
			Object result = caseIIterator(iIterator);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.ITYPES: {
			...
			Object result = caseITypes(iTypes);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case WSDLPackage.IELEMENT_EXTENSIBLE: {
			...
			Object result = caseIElementExtensible(iElementExtensible);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IATTRIBUTE_EXTENSIBLE: {
			...
			Object result = caseIAttributeExtensible(iAttributeExtensible);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.IOBJECT: {
			...
			Object result = caseIObject(iObject);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WSDLPackage.ISCHEMA: {
			...
			Object result = caseISchema(iSchema);
			if (result == null)
				result = caseIExtensibilityElement(iSchema);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
