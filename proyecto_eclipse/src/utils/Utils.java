...
public class Utils {
	...
	/**
	 * (*+)Obtiene una lista de EObject dado la ruta de un archivo .xmi
	 * almacenado en disco
	 * 
	 * @param path
	 * @return
	...
	/**
	 * (*+)Exporta una Definition de un modelo ecore a un archivo de texto con
	 * extensión .xmi
	 * 
	 * @param definition
	 */
	public static void exportWSDLtoXMI(Definition definition) {
		...
		Resource resource = resSet.createResource(org.eclipse.emf.common.util.URI
				.createURI(getAbsolutePathRunning() + "/folder_outputs/" + definition.getQName() + ".xmi"));
	...
	/**
	 * (*+) Exporta un RequestModel de un modelo ecore a un archivo de texto con
	 * extensión .xmi
	 * 
	 * @param definition
	 */
	public static void exportRequestModeltoXMI(RequestModel requestModel) {
		...
		// create a resource
		Resource resource = resSet.createResource(org.eclipse.emf.common.util.URI
				.createURI(getAbsolutePathRunning() + "/folder_outputs/" + requestModel.getName() + ".xmi"));
		// Get the first model element and cast it to the right type, in my
		// example everything is hierarchical included in this first node
