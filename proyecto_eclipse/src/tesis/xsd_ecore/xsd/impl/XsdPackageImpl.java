...
import tesis.wsdl_ecore.wsdl.impl.WsdlPackageImpl;
...
import tesis.xsd_ecore.xsd.XSDCardinality;
...
import tesis.xsd_ecore.xsd.XSDComponent;
...
import tesis.xsd_ecore.xsd.XSDInclude;
...
import tesis.xsd_ecore.xsd.XSDOrdered;
...
import tesis.xsd_ecore.xsd.XsdFactory;
...
public class XsdPackageImpl extends EPackageImpl implements XsdPackage {
	 ...
	 * @see tesis.xsd_ecore.xsd.XsdPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void createPackageContents() {
		...
		xsdxPathDefinitionEClass = createEClass(XSDX_PATH_DEFINITION);
		createEAttribute(xsdxPathDefinitionEClass, XSDX_PATH_DEFINITION__VARIETY);
		createEAttribute(xsdxPathDefinitionEClass, XSDX_PATH_DEFINITION__VALUE);
		createEReference(xsdxPathDefinitionEClass, XSDX_PATH_DEFINITION__ANNOTATION);
		...
		xsdxPathVarietyEEnum = createEEnum(XSDX_PATH_VARIETY);
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(xsdAttributeUseCategoryEEnum, XSDAttributeUseCategory.OPTIONAL);
		addEEnumLiteral(xsdAttributeUseCategoryEEnum, XSDAttributeUseCategory.PROHIBITED);
		addEEnumLiteral(xsdAttributeUseCategoryEEnum, XSDAttributeUseCategory.REQUIRED);

		initEEnum(xsdCardinalityEEnum, XSDCardinality.class, "XSDCardinality");
		addEEnumLiteral(xsdCardinalityEEnum, XSDCardinality.FINITE);
		addEEnumLiteral(xsdCardinalityEEnum, XSDCardinality.COUNTABLY_INFINITE);

		initEEnum(xsdComplexFinalEEnum, XSDComplexFinal.class, "XSDComplexFinal");
		addEEnumLiteral(xsdComplexFinalEEnum, XSDComplexFinal.EXTENSION);
		addEEnumLiteral(xsdComplexFinalEEnum, XSDComplexFinal.RESTRICTION);
		addEEnumLiteral(xsdComplexFinalEEnum, XSDComplexFinal.ALL);

		initEEnum(xsdCompositorEEnum, XSDCompositor.class, "XSDCompositor");
		addEEnumLiteral(xsdCompositorEEnum, XSDCompositor.ALL);
		addEEnumLiteral(xsdCompositorEEnum, XSDCompositor.CHOICE);
		addEEnumLiteral(xsdCompositorEEnum, XSDCompositor.SEQUENCE);

		initEEnum(xsdConstraintEEnum, XSDConstraint.class, "XSDConstraint");
		addEEnumLiteral(xsdConstraintEEnum, XSDConstraint.DEFAULT);
		addEEnumLiteral(xsdConstraintEEnum, XSDConstraint.FIXED);

		initEEnum(xsdContentTypeCategoryEEnum, XSDContentTypeCategory.class, "XSDContentTypeCategory");
		addEEnumLiteral(xsdContentTypeCategoryEEnum, XSDContentTypeCategory.EMPTY);
		addEEnumLiteral(xsdContentTypeCategoryEEnum, XSDContentTypeCategory.SIMPLE);
		addEEnumLiteral(xsdContentTypeCategoryEEnum, XSDContentTypeCategory.MIXED);
		addEEnumLiteral(xsdContentTypeCategoryEEnum, XSDContentTypeCategory.ELEMENT_ONLY);

		initEEnum(xsdDerivationMethodEEnum, XSDDerivationMethod.class, "XSDDerivationMethod");
		addEEnumLiteral(xsdDerivationMethodEEnum, XSDDerivationMethod.EXTENSION);
		addEEnumLiteral(xsdDerivationMethodEEnum, XSDDerivationMethod.RESTRICTION);

		initEEnum(xsdDiagnosticSeverityEEnum, XSDDiagnosticSeverity.class, "XSDDiagnosticSeverity");
		addEEnumLiteral(xsdDiagnosticSeverityEEnum, XSDDiagnosticSeverity.FATAL);
		addEEnumLiteral(xsdDiagnosticSeverityEEnum, XSDDiagnosticSeverity.ERROR);
		addEEnumLiteral(xsdDiagnosticSeverityEEnum, XSDDiagnosticSeverity.WARNING);
		addEEnumLiteral(xsdDiagnosticSeverityEEnum, XSDDiagnosticSeverity.INFORMATION);

		initEEnum(xsdDisallowedSubstitutionsEEnum, XSDDisallowedSubstitutions.class, "XSDDisallowedSubstitutions");
		addEEnumLiteral(xsdDisallowedSubstitutionsEEnum, XSDDisallowedSubstitutions.SUBSTITUTION);
		addEEnumLiteral(xsdDisallowedSubstitutionsEEnum, XSDDisallowedSubstitutions.EXTENSION);
		addEEnumLiteral(xsdDisallowedSubstitutionsEEnum, XSDDisallowedSubstitutions.RESTRICTION);
		addEEnumLiteral(xsdDisallowedSubstitutionsEEnum, XSDDisallowedSubstitutions.ALL);

		initEEnum(xsdFormEEnum, XSDForm.class, "XSDForm");
		addEEnumLiteral(xsdFormEEnum, XSDForm.QUALIFIED);
		addEEnumLiteral(xsdFormEEnum, XSDForm.UNQUALIFIED);

		initEEnum(xsdIdentityConstraintCategoryEEnum, XSDIdentityConstraintCategory.class, "XSDIdentityConstraintCategory");
		addEEnumLiteral(xsdIdentityConstraintCategoryEEnum, XSDIdentityConstraintCategory.KEY);
		addEEnumLiteral(xsdIdentityConstraintCategoryEEnum, XSDIdentityConstraintCategory.KEYREF);
		addEEnumLiteral(xsdIdentityConstraintCategoryEEnum, XSDIdentityConstraintCategory.UNIQUE);

		initEEnum(xsdNamespaceConstraintCategoryEEnum, XSDNamespaceConstraintCategory.class, "XSDNamespaceConstraintCategory");
		addEEnumLiteral(xsdNamespaceConstraintCategoryEEnum, XSDNamespaceConstraintCategory.ANY);
		addEEnumLiteral(xsdNamespaceConstraintCategoryEEnum, XSDNamespaceConstraintCategory.NOT);
		addEEnumLiteral(xsdNamespaceConstraintCategoryEEnum, XSDNamespaceConstraintCategory.SET);

		initEEnum(xsdOrderedEEnum, XSDOrdered.class, "XSDOrdered");
		addEEnumLiteral(xsdOrderedEEnum, XSDOrdered.FALSE);
		addEEnumLiteral(xsdOrderedEEnum, XSDOrdered.PARTIAL);
		addEEnumLiteral(xsdOrderedEEnum, XSDOrdered.TOTAL);

		initEEnum(xsdProcessContentsEEnum, XSDProcessContents.class, "XSDProcessContents");
		addEEnumLiteral(xsdProcessContentsEEnum, XSDProcessContents.STRICT);
		addEEnumLiteral(xsdProcessContentsEEnum, XSDProcessContents.LAX);
		addEEnumLiteral(xsdProcessContentsEEnum, XSDProcessContents.SKIP);

		initEEnum(xsdProhibitedSubstitutionsEEnum, XSDProhibitedSubstitutions.class, "XSDProhibitedSubstitutions");
		addEEnumLiteral(xsdProhibitedSubstitutionsEEnum, XSDProhibitedSubstitutions.EXTENSION);
		addEEnumLiteral(xsdProhibitedSubstitutionsEEnum, XSDProhibitedSubstitutions.RESTRICTION);
		addEEnumLiteral(xsdProhibitedSubstitutionsEEnum, XSDProhibitedSubstitutions.ALL);

		initEEnum(xsdSimpleFinalEEnum, XSDSimpleFinal.class, "XSDSimpleFinal");
		addEEnumLiteral(xsdSimpleFinalEEnum, XSDSimpleFinal.LIST);
		addEEnumLiteral(xsdSimpleFinalEEnum, XSDSimpleFinal.RESTRICTION);
		addEEnumLiteral(xsdSimpleFinalEEnum, XSDSimpleFinal.UNION);
		addEEnumLiteral(xsdSimpleFinalEEnum, XSDSimpleFinal.ALL);

		initEEnum(xsdSubstitutionGroupExclusionsEEnum, XSDSubstitutionGroupExclusions.class, "XSDSubstitutionGroupExclusions");
		addEEnumLiteral(xsdSubstitutionGroupExclusionsEEnum, XSDSubstitutionGroupExclusions.EXTENSION);
		addEEnumLiteral(xsdSubstitutionGroupExclusionsEEnum, XSDSubstitutionGroupExclusions.RESTRICTION);

		initEEnum(xsdVarietyEEnum, XSDVariety.class, "XSDVariety");
		addEEnumLiteral(xsdVarietyEEnum, XSDVariety.ATOMIC);
		addEEnumLiteral(xsdVarietyEEnum, XSDVariety.LIST);
		addEEnumLiteral(xsdVarietyEEnum, XSDVariety.UNION);

		initEEnum(xsdWhiteSpaceEEnum, XSDWhiteSpace.class, "XSDWhiteSpace");
		addEEnumLiteral(xsdWhiteSpaceEEnum, XSDWhiteSpace.PRESERVE);
		addEEnumLiteral(xsdWhiteSpaceEEnum, XSDWhiteSpace.REPLACE);
		addEEnumLiteral(xsdWhiteSpaceEEnum, XSDWhiteSpace.COLLAPSE);

		initEEnum(xsdxPathVarietyEEnum, XSDXPathVariety.class, "XSDXPathVariety");
		addEEnumLiteral(xsdxPathVarietyEEnum, XSDXPathVariety.SELECTOR);
		addEEnumLiteral(xsdxPathVarietyEEnum, XSDXPathVariety.FIELD);
