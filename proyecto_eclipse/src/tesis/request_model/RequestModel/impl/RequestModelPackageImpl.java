 ...
 * @generated
 */
public class RequestModelPackageImpl extends EPackageImpl implements RequestModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass requestModelEClass = null;
	 ...
	 * @see tesis.request_model.RequestModel.RequestModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RequestModelPackageImpl() {
		super(eNS_URI, RequestModelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link RequestModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RequestModelPackage init() {
		if (isInited) return (RequestModelPackage)EPackage.Registry.INSTANCE.getEPackage(RequestModelPackage.eNS_URI);

		// Obtain or create and register package
		RequestModelPackageImpl theRequestModelPackage = (RequestModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RequestModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RequestModelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theRequestModelPackage.createPackageContents();

		// Initialize created meta-data
		theRequestModelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRequestModelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RequestModelPackage.eNS_URI, theRequestModelPackage);
		return theRequestModelPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getRequestModel() {
		return requestModelEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getMethod_InParameters() {
	 ...
	 * @generated
	 */
	public EReference getMethod_OutParameters() {
	 ...
	 * @generated
	 */
	public RequestModelFactory getRequestModelFactory() {
		return (RequestModelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(methodEClass, METHOD__OUT_PARAMETERS);
	...
	public void initializePackageContents() {
		...
		initEReference(getMethod_OutParameters(), this.getParameter(), null, "outParameters", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
