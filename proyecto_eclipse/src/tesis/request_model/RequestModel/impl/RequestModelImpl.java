...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Request Model</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class RequestModelImpl extends MinimalEObjectImpl.Container implements RequestModel {
	...
	protected EClass eStaticClass() {
		return RequestModelPackage.Literals.REQUEST_MODEL;
	}
	...
	public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentEList<Method>(Method.class, this, RequestModelPackage.REQUEST_MODEL__METHODS);
		}
		return methods;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequestModelPackage.REQUEST_MODEL__NAME, oldName, name));
	}
